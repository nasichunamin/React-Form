...
export default function FormData(){
    ...
    const handleInput = e => {
        ...
        if (name === "noHandphone") {
            if (value.length > 0 && !regexNumbers.test(value)) {
                setErrors(name, "No Handphone Tidak Sesuai (inputan hanya berupa angka)!");
            } else if (value.length < 9 || value.length > 14) {
                setErrors(name, "Nomor Handphone wajib 9-14 character!");
            } else {
                setErrors(name, "");
            }
        }
    ...
    const handleSubmit = (e) =>{
        ...
        if (data.noHandphone.trim().length === 0) {
            ...
            setErrors("noHandphone", "No Handphone Tidak Sesuai (inputan hanya berupa angka)!");
            valid = false;
        } else if (data.noHandphone.length < 9 || data.noHandphone.length > 14) {
            setErrors(
                "noHanphone",
                "No Handphone wajib 9-14 character!"
            );
            valid = false;
        }

        if (data.pendidikan === "") {
            setErrors("pendidikan", "Harap memilih salah satu!");
            valid = false;
        }
                        ...
                        <div className="col-md-7">
                            ...
                            <div className="mb-3">
                                <label 
                                    ...
                                    style={{width:"100%", textAlign:"start", fontWeight:"bold"}}>Email:
                                </label>
                                <input 
                                    type="email" 
                                    className="form-control" 
                            ...
                            <div className="mb-3">
                                <label 
                                    for="noHandphone" 
                                    className="form-label"
                                    style={{width:"100%", textAlign:"start", fontWeight:"bold"}}>No Handphone:
                                </label>
                                <input 
                                    type="text" 
                                    className="form-control"
                            ...
                            <div className="mb-3">
                                <label 
                                    className="form-label"
                                    for="latarPendidikan"
                                    style={{width:"100%", textAlign:"start", fontWeight:"bold"}}>Latar Belakang Pendidikan:
                                </label>
                                <div className="form-check">
                                    ...
                                    <label 
                                        ...
                                        for="it"
                                        style={{width:"100%", textAlign:"start"}}>IT
                                    </label>
                                </div>
                                <div className="form-check">
                                    <input 
                                    ...
                                    <label 
                                        className="form-check-label" 
                                        for="nonit"
                                        style={{width:"100%", textAlign:"start"}}>Non IT
                                    </label>
                            ...
                            <div className="mb-3">
                                <label 
                                    className="form-label"
                                    for="Program"
                                    style={{width:"100%", textAlign:"start", fontWeight:"bold"}}>Kelas Coding yang Dipilih:</label>
                            ...
                            <div className="mb-3">
                                <label 
                                    for="surat" 
                                    className="form-label"
                                    style={{width:"100%", textAlign:"start", fontWeight:"bold"}}>Foto Surat Kesungguhan:
                                </label>
                                <input 
                            ...
                            <div class="mb-3">
                                <label 
                                    for="harapan" 
                                    className="form-label"
                                    style={{width:"100%", textAlign:"start", fontWeight:"bold"}}>Harapan Untuk Coding Bootcamp Ini:
                                </label>
                                <textarea 
                                    className="form-control" 
                                    id="harapan" 
